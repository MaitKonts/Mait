        ...
        <form method="post" action="">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td><input type="text" name="mining_speed_per_1_computer" required /></td>
                </tr>
                <tr valign="top">
...
function buy_computer_shortcode(){
    ...
    // Assuming players are identified by their user ID
    ...
    if(isset($_POST['buy_computer'])){
        ...
        if($player->money >= 5000 && $player->moves >= 50){
            ...
            // Update the player object to reflect the new values
